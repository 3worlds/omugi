...
class GraphParserTest {
	...
	String[] otherTest = {"graph // checking the new ids\n", 
			...
			"  node=String(\"fr.cnrs.iees.omugi.graph.impl.ALNode\")\n",
			"  pnode=String(\"fr.cnrs.iees.omugi.graph.impl.ALDataNode\")\n",
			"  edge=String(\"fr.cnrs.iees.omugi.graph.impl.ALEdge\")\n", 
	...
	String[] edgePropTest = {"graph // checking the new ids\n", 
			...
			"  pnode=String(\"fr.cnrs.iees.omugi.graph.impl.ALDataNode\")\n",
			"  edge=String(\"fr.cnrs.iees.omugi.graph.impl.ALEdge\")\n",
			"  pedge=String(\"fr.cnrs.iees.omugi.graph.impl.ALDataEdge\")\n", 
			"  mutable=Boolean(true)\n",
			"\n",
			"// nodes\n", 
			"pnode\n",
