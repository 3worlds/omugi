...
public class TreeTokenizer2 extends LineTokenizer2 {
	
	private Logger log = Logger.getLogger(TreeTokenizer2.class.getName());
	...
	public TreeTokenizer2(FileTokenizer2 parent) {
		super(parent);
	}

	public TreeTokenizer2(String[] lines) {
		super(lines);
	}
