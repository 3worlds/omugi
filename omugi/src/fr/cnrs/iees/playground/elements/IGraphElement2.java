...
public interface IGraphElement2 extends Textable, Identity {
	 ...
	 */
	public default IGraphElement2 connectLike(IGraphElement2 element) {
		disconnect();
	 ...
	 */
	public default IGraphElement2 replace(IGraphElement2 element) {
		addConnectionsLike(element);
		element.disconnect();
		return this;
	}
	 ...
	 * @param element the element to copy connections from.
	 */
	public IGraphElement2 addConnectionsLike(IGraphElement2 element);
