 ...
 * and instantiates the matching tokenizer. {@link fr.cnrs.iees.io.parsing.impl.GraphTokenizer GraphTokenizer}, 
 * {@link fr.cnrs.iees.io.parsing.impl.TreeTokenizer TreeTokenizer}, and
 * {@link fr.cnrs.iees.io.parsing.impl.TreeGraphTokenizer TreeGraphTokenizer}, transform the text lines into an internal representation of
 * graph/tree elements (<em>token</em>s). {@code PreTokenizer} also returns the matching parser.</p>
 * 
 * <p>The {@link fr.cnrs.iees.io.parsing.impl.ReferenceTokenizer ReferenceTokenizer} analyses Strings describing a location in a tree, using
