...
public enum GraphProperties {
	...
	NODE_FACTORY	("node_factory",			"fr.cnrs.iees.graph.NodeFactory",			"fr.cnrs.iees.graph.impl.ALGraphFactory"),
	/** The name of the {@link EdgeFactory} to use to instantiate the graph edges */
	EDGE_FACTORY	("edge_factory",			"fr.cnrs.iees.graph.EdgeFactory",			"fr.cnrs.iees.graph.impl.ALGraphFactory"),
	/** The name of the {@link PropertyListFactory} to use to instantiate the property lists used in the graph nodes and edges */
	PROP_FACTORY	("property_list_factory",	"fr.cnrs.iees.properties.PropertyListFactory",	"fr.cnrs.iees.graph.impl.ALGraphFactory"),
