...
import fr.cnrs.iees.omugi.io.parsing.impl.TreeTokenizer.treeToken;
import fr.cnrs.iees.omugi.properties.SimplePropertyList;

/**
 * <p>A parser for {@link fr.cnrs.iees.omugi.graph.impl.TreeGraph TreeGraph}s. 
...
public class TreeGraphParser extends EdgeAndNodeSetParser {
	...
	public TreeGraphParser(TreeGraphTokenizer tokenizer) {
		...
		defaultGraphProperties.put(CLASS, 			"fr.cnrs.iees.omugi.graph.impl.TreeGraph");
		defaultGraphProperties.put(NODE_FACTORY, 	"fr.cnrs.iees.omugi.graph.impl.TreeGraphFactory");
		defaultGraphProperties.put(EDGE_FACTORY, 	"fr.cnrs.iees.omugi.graph.impl.TreeGraphFactory");
//		defaultGraphProperties.put(PROP_FACTORY, 	"fr.cnrs.iees.omugi.graph.impl.TreeGraphFactory");
