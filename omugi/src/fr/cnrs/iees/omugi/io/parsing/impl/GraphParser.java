...
import fr.cnrs.iees.omugi.io.parsing.impl.GraphTokenizer.graphToken;
 ...
 * (cf. {@link fr.cnrs.iees.omugi.properties.PropertyListGetters PropertyListGetters} descendants) should be used to construct
 * the graph.</p>
 *
 ...
 *
 *  <p>Note that the best use of this class is to hide it inside a {@link fr.cnrs.iees.omugi.graph.io.GraphImporter GraphImporter}.</p>
 *
...
public class GraphParser extends EdgeAndNodeSetParser {
	...
	public GraphParser(GraphTokenizer tokenizer) {
		...
		defaultGraphProperties.put(CLASS, 			"fr.cnrs.iees.omugi.graph.impl.ALGraph");
		defaultGraphProperties.put(NODE_FACTORY, 	"fr.cnrs.iees.omugi.graph.impl.ALGraphFactory");
		defaultGraphProperties.put(EDGE_FACTORY, 	"fr.cnrs.iees.omugi.graph.impl.ALGraphFactory");
//		defaultGraphProperties.put(PROP_FACTORY, 	"fr.cnrs.iees.omugi.graph.impl.ALGraphFactory");
