 ...
 * {@link fr.cnrs.iees.omugi.properties.PropertyListGetters PropertyListGetters} descendants) should be used to construct the
 * tree.
 * </p>
 * 
 * <p>
 ...
 * {@link fr.cnrs.iees.omugi.graph.io.GraphImporter GraphImporter}.
 * </p>
 * 
...
public class TreeParser extends NodeSetParser {
	...
	public TreeParser(TreeTokenizer tokenizer) {
		...
		defaultGraphProperties.put(CLASS, 			"fr.cnrs.iees.omugi.graph.impl.SimpleTree");
		defaultGraphProperties.put(NODE_FACTORY, 	"fr.cnrs.iees.omugi.graph.impl.SimpleTreeFactory");
//		defaultGraphProperties.put(PROP_FACTORY, 	"fr.cnrs.iees.omugi.graph.impl.SimpleTreeFactory");
