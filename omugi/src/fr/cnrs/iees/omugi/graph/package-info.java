 ...
 * ({@link fr.cnrs.iees.omugi.identity.Identity Identity} interface), and various methods from the
 ...
 * nodes and edges (cf. the {@link fr.cnrs.iees.omugi.graph.property} and 
 * {@link fr.cnrs.iees.omugi.collections.tables} packages).</p>
 * 
