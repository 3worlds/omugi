 ...
 * 
 * <p>A typical use case is shown on the diagram: {@link fr.cnrs.iees.omugi.graph.GraphFactory GraphFactory} uses a {@code IdentityScope}
 * internally to construct instances of {@link fr.cnrs.iees.omugi.graph.Element Element}s that have a identifier guaranteed unique 
