...
public interface IdentityScope {
	 ...
	 * 
	 * @param addToScope argument only used in {@link fr.cnrs.iees.omugi.identity.impl.LocalScope LocalScope} (whether the id should be recorded
	 ...
	 * {@link fr.cnrs.iees.omugi.identity.impl.PairLocalScope PairLocalScope} [NOTE: one more flaw in the design!]
	 * @return a new Identity instance, unique over this scope
	 */
